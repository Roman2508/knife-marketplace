            ...
            {currentUser ? (
              ...
              <>
                <Button
                  asChild
                  variant="ghost"
                  className="border-2 rounded-none border-foreground bg-background px-4 py-2 text-xs font-black uppercase tracking-wider shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:text-foreground transition-all hover:-translate-y-0.5 hover:bg-background hover:shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] dark:hover:shadow-[5px_5px_0px_0px_rgba(255,255,255,1)]"
                >
                  <Link href="/login">Вхід</Link>
                </Button>
                <Button
                  asChild
                  className="border-2 rounded-none border-foreground bg-primary px-4 py-2 text-xs font-black uppercase tracking-wider text-primary-foreground shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all hover:-translate-y-0.5 hover:bg-primary hover:shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] dark:hover:shadow-[5px_5px_0px_0px_rgba(255,255,255,1)]"
                >
